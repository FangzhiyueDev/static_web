/*
Cache: jquery-lazy, dt-main, dt-language, dt-main-op-jquery, dt-plugins, wc-cart-fragments, jquery-cookie, bitcommerce, jquery-blockui, wc-single-product, jquery-form, waypoints, vc_carousel_js, vc_transition_bootstrap_js, qfe_composer_front_js, thickbox, jquery-migrate, jquery-core
*/
/* jquery-core: (http://58745a1972c6f.t73.qifeiye.com/qfy-includes/js/jquery/jquery.js) */
...
/* jquery-migrate: (http://58745a1972c6f.t73.qifeiye.com/qfy-includes/js/jquery/jquery-migrate.min.js) */
...
/* thickbox: (http://58745a1972c6f.t73.qifeiye.com/qfy-includes/js/thickbox/thickbox.js) */
/*
...
/* qfe_composer_front_js: (http://58745a1972c6f.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/js/qfy_editor_front.js) */
...
/* vc_transition_bootstrap_js: (http://58745a1972c6f.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/vc_carousel/js/transition.js) */
+function ($) { "use strict";
...
/* vc_carousel_js: (http://58745a1972c6f.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/vc_carousel/js/vc_carousel.js) */
/* ========================================================================
...
/* waypoints: (http://58745a1972c6f.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/jquery-waypoints/waypoints.min.js) */
...
/* jquery-form: (http://58745a1972c6f.t73.qifeiye.com/qfy-includes/js/jquery/jquery.form.min.js) */
/*!
 * jQuery Form Plugin
...
/* bitcommerce: (http://58745a1972c6f.t73.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/frontend/bitcommerce.min.js) */
				...
				success:function(data){
					...
					if(obj.status=="success"){
						...
						if(isajax==2){
							...
							var  tr = "<tr class='cart_btton_popinfo  qfyanimated' style='position:absolute;opacity:0;"+trtop+";animation-duration: 1s; animation-delay: 0s; '><td colspan=2 style='padding:0;'><div style='width:"+(tablewidth)+"px;padding:20px 5px 20px 20px;border:2px solid #ddd;background: #fff;margin-top:10px;text-align:left;'> <span style='color:#555555;font-weight:700;font-size:12px;'>"+text1+"</span>&nbsp;&nbsp;<a href='"+url+"'><button type='button' style='background-color:"+bgcolor+";border:1px solid "+bgcolor+";color:"+color+";padding:4px 9px;font-size:12px;'>"+text2+"</button></a>&nbsp;&nbsp;<span style='cursor:pointer;position:absolute;right: 6px;top: 12px;color: #666;font-size:12px;' class='close_cart'>✕</span></div></td></tr>";
							if(body_w>992){
...
function _cart_update(obj,e){
	...
	sidebar.block({message: null, overlayCSS: {background: '#fff url(//fast.qifeiye.com/qfy-content/plugins/bitcommerce/assets/images/ajax-loader@2x.gif) no-repeat center', backgroundSize: '16px 16px', opacity: 0.6}});
...
function get_one_coupon(obj){
	...
	if(jQuery(obj).hasClass("loading") ){
		...
		jQuery(obj).addClass("loading").append("<div class='loadingdiv' style='width:100%;height:100%;position:absolute;top:0;left:0;;background:url(//fast.qifeiye.com/qfy-content/plugins/bitcommerce/assets/images/ajax-loader@2x.gif) no-repeat center rgba(255,255,255,0.2)'></div>");
	}
	...
	jQuery.post("/admin/admin-ajax.php", data, function( response ) {
		...
		if(response=="success"){
			...
			qfy_popinfo_fun('<div style="text-align:center;" ><div style="padding:20px;">'+(p.attr("data-failmsg1")?p.attr("data-failmsg1"):"优惠劵领取失败，请登录!")+'</div></div>',3)
		}else{
			qfy_popinfo_fun('<div style="text-align:center;" ><div style="padding:20px;">'+(p.attr("data-failmsg2")?p.attr("data-failmsg2"):"优惠劵领取失败")+'</div></div>',3)
		}
	});
}
;

/* jquery-cookie: (http://58745a1972c6f.t73.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/jquery-cookie/jquery.cookie.min.js) */
/*!
...
/* wc-cart-fragments: (http://58745a1972c6f.t73.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/frontend/cart-fragments.min.js) */
...
/* dt-plugins: (http://58745a1972c6f.t73.qifeiye.com/qfy-content/themes/qfy-01/js/plugins.js) */
/*jquery-parallax*/
/*scroll 用到*/
...
/* dt-main-op-jquery: (http://58745a1972c6f.t73.qifeiye.com/FeiEditor/bitSite/js/opentip-jquery.min.js) */
// Opentip v2.4.6
...
/* dt-language: (http://58745a1972c6f.t73.qifeiye.com/qfy-content/themes/qfy-01/js/language.js) */
jQuery(function(){
...
/* dt-main: (http://58745a1972c6f.t73.qifeiye.com/qfy-content/themes/qfy-01/js/main.js) */
//悬浮效果
...
jQuery(document).ready(function($) {
	...
	//$(".tp-loader, .ls-defaultskin .ls-loading-indicator").not(".loading-label").append('<svg class="fa-spinner" viewBox="0 0 48 48" ><path d="M23.98,0.04c-13.mp4.055,0-23.673,10.434-23.973,23.417C0.284,12.128,8.898,3.038,19.484,3.038c10.76,0,19.484,9.395,19.484,20.982c0,2.483,2.013,4.497,4.496,4.497c2.482,0,4.496-2.014,4.496-4.497C47.96,10.776,37.224,0.04,23.98,0.04z M23.98,48c13.055,0,23.673-10.434,23.972-23.417c-0.276,11.328-8.89,20.42-19.476,20.42	c-10.76,0-19.484-9.396-19.484-20.983c0-2.482-2.014-4.496-4.497-4.496C2.014,19.524,0,21.537,0,24.02C0,37.264,10.736,48,23.98,48z"/></svg>');
...
/* jquery-lazy: (http://58745a1972c6f.t73.qifeiye.com/qfy-includes/js/jquery.lazy.min.js) */
